    ...
    <div class="flex flex-col h-screen overflow-hidden bg-gray-50">
      ...
      <header class="border-b border-gray-200 bg-white h-14 flex items-center gap-4 px-4 shrink-0 z-10">
        <div class="flex items-center gap-2">
          <!-- Robot face logo -->
          <img src="assets/face.png" alt="Eagle Robot" width="32" height="32" class="object-contain" />
...
export class EaglePrototypeComponent {
  ...
  subItems: SidebarItem[] = [
    { icon: 'bot', label: 'Роботы Eagle', route: 'robots' },
  ...
  constructor() {
    ...
    this.router.events.pipe(
      ...
      const basePath = '/prototype/eagle';
  ...
  getCurrentScreenLabel(): string {
    ...
    if (url.includes('/robots')) return 'Роботы Eagle';
