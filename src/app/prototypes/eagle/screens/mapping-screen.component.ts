...
export class MappingScreenComponent implements OnInit {
  ...
  ngOnInit(): void {
    setTimeout(() => {
      this.robots = this.storage.load('eagle', 'robots', MOCK_ROBOTS);
      this.tables = this.storage.load('eagle', 'tables', [...MOCK_TABLES]);
  ...
  loadMappings(): void {
    ...
    setTimeout(() => {
      ...
      this.mappings = this.storage.load('eagle', 'mappings', defaultMappings);
  ...
  saveMapping(): void {
    this.originalMappings = this.cloneMappings(this.mappings);
    this.storage.save('eagle', 'mappings', this.mappings);
    this.storage.save('eagle', 'tables', this.tables);
    this.hasChanges = false;
