...
@Component({
  selector: 'app-arrivals-controls-screen',
  standalone: true,
  imports: [CommonModule, IconsModule, UiConfirmDialogComponent],
  template: `
    <div class="controls-screen">
      <div class="page-header">
        <h1 class="page-title">Контролы электронной очереди</h1>
...
export class ArrivalsControlsScreenComponent {
  ...
  onRowClick(item: ArrivalsControlListItem): void {
    if (item.itemType === 'control') {
      this.router.navigate(['/prototype/web-screens/arrivals-control-editor', item.id]);
    }
  }
  ...
  onAdd(): void {
    this.router.navigate(['/prototype/web-screens/arrivals-control-editor', 'new']);
  }
