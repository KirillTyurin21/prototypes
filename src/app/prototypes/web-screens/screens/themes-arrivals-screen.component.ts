...
export class ThemesArrivalsScreenComponent {
  ...
  /** Тема содержит платный элемент «Область» (для метки платного контента) */
  themeHasPremium(themeId: number): boolean {
    const themes: any[] = this.storage.load('web-screens', 'arrivals-themes', []);
