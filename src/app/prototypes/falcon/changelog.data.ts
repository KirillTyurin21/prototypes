    ...
    changes: [
      {
        ...
        items: [
          ...
          'Кнопка «Falcon: Повторить отправку» вынесена на уровень плагинов (рядом с «Falcon: Команды»)',
    ...
    changes: [
      {
        ...
        items: [
          ...
          'Добавлено окно «Плагины» из контекста заказа с кнопкой «Falcon: Команды»',
    ...
    changes: [
      ...
      },
      {
        ...
        items: [
          ...
          'В окне «Плагины» — кнопки «Falcon: Статус роботов» и «Falcon: Команды»',
      ...
      },
      {
        ...
        pageRoute: '/prototype/falcon/pos?context=main',
        items: [
          'В цепочке «Дополнения → Falcon: Команды → Уборка (Столы)» перед выбором столов теперь показывается окно «Выбор робота» (статусы роботов) с кнопкой «Выбрать столы для уборки →»',
