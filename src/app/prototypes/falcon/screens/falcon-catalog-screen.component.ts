...
@Component({
  selector: 'app-falcon-catalog-screen',
  standalone: true,
      ...
      <div class="bg-white border-b border-gray-200">
        <div class="max-w-6xl mx-auto px-6 py-4">
          ...
          <nav class="text-sm text-gray-400 mb-2">
            ...
            <span class="mx-1">/</span>
            <span class="text-gray-600">Falcon — Управление роботами</span>
          </nav>
...
export class FalconCatalogScreenComponent {
