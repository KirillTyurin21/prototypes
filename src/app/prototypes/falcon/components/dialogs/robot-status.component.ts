...
@Component({
  selector: 'falcon-robot-status',
  standalone: true,
  imports: [CommonModule, FalconPosDialogComponent, IconsModule, DatePipe],
  template: `
    <falcon-pos-dialog [open]="open" maxWidth="lg" (dialogClose)="onCloseClick()">
      <div class="space-y-4">
        <!-- Header -->
        <div>
