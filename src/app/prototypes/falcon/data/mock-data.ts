...
export const MOCK_ROBOTS: FalconRobot[] = [
  {
...
export function getAssignedRobot(): FalconRobot {
  return MOCK_ROBOTS.find(r => r.status === 'idle') || MOCK_ROBOTS[0];
}

// v1.5 I7: двойные имена в уведомлениях
export const MOCK_NOTIFICATIONS: FalconNotification[] = [
  {
    id: 'notif-001',
    type: 'error',
...
export const MOCK_NE_ERROR_NOTIFICATIONS: FalconNotification[] = [
  {
    id: 'notif-003',
    type: 'error',
...
export const MOCK_Falcon_DIALOGS: FalconDialogEntry[] = [
  {
