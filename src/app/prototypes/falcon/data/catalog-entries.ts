...
const CONTEXT_ORDER_CELLS: CatalogCell[] = [
  {
    ...
    description: 'Кнопка «Дополнения → Плагины» из экрана заказа. Открывает окно «Плагины» с кнопкой «Falcon: Команды»',
    icon: 'puzzle',
    iconColor: '#b8c959',
  ...
  },
  {
    ...
    iconColor: '#3b82f6',
    category: 'context-order',
    modalType: 'falcon_commands_order',
    context: 'order',
    badge: 'v1.9',
    badgeColor: '#8b5cf6',
  },
...
const CONTEXT_MAIN_CELLS: CatalogCell[] = [
  {
    ...
    label: 'Дополнения → Плагины',
    description: 'Кнопка «Дополнения» → окно «Плагины» с кнопками Falcon: Статус роботов и Falcon: Команды',
    icon: 'puzzle',
    iconColor: '#b8c959',
